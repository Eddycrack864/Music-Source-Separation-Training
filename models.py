...
downloads = [
  ...
  ("https://huggingface.co/Eddycrack864/Music-Source-Separation-Training/resolve/main/model_bandit_plus_dnr_sdr_11.47.chpt", f"{download_dir}/model_mel_band_roformer_crowd.yaml"),
